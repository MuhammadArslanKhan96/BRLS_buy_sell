    ...
    return (
        <div className="flex justify-between py-6 px-8 max-sm:px-4 max-sm:py-3 items-center border-b bg-[#000C28] h-[10vh]">
            <div className="container mx-auto flex justify-between items-center">
                <p className="font-bold text-xl text-[#FFFFFF] max-sm:text-sm">BRLS Buy Sell</p>
                {!wallet ? (
                ...
                {model && (
                    <div className="absolute z-10 top-[0%] w-[90%] h-[100%]">
                        <div className="flex justify-center items-center h-full">
                            <WalletConnect model={model} setModel={setModel} getWalletFunction={getWalletFunction} />
                        </div>
                    </div>
                )}
            </div>
